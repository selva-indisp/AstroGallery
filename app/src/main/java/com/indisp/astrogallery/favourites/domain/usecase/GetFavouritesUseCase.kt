    ...
    suspend operator fun invoke(): List<Apod> {
        ...
        return listOf(
            ...
            Apod("MACS 1206: A Galaxy Cluster Gravitational Lens",
                ...
                "Mohan", URL("https://apod.nasa.gov/apod/image/1110/macs1206_hst_973.jpg"),LocalDate.parse("2006-08-13", incomingDateFormat)),
            Apod("Cape York Annular Eclipse",
                ...
                "MWV Observatory", URL("https://apod.nasa.gov/apod/image/1305/ASE_McCarty3-3.jpg"),LocalDate.parse("2006-08-13", incomingDateFormat)),
            Apod("The Elephant's Trunk in IC 1396",
                ...
                "Brian Lula", URL("https://apod.nasa.gov/apod/image/0710/vdB142_lula.jpg"),LocalDate.parse("2006-08-13", incomingDateFormat)),
            Apod("Dragon Aurora over Iceland",
                ...
                "Jingyi Zhang", URL("https://apod.nasa.gov/apod/image/1902/DragonAurora_Zhang_2241.jpg"),LocalDate.parse("2006-08-13", incomingDateFormat)),
            Apod("Nearby Spiral Galaxy NGC 4945",
                ...
                "SSRO", URL("https://apod.nasa.gov/apod/image/1301/NGC4945_Master23.jpg"),LocalDate.parse("2006-08-13", incomingDateFormat)),
        )
    }
}
