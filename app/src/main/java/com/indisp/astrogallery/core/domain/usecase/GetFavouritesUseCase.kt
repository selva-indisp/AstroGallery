...
class GetFavouritesUseCase(private val apodRepository: ApodRepository) {
    suspend operator fun invoke(): Flow<List<Apod>> = apodRepository.getFavourites()
}

//flow {
//    delay(1000)
//    return apodRepository.getFavourites()
...
//                "J. C. Casado",
//                URL("https://apod.nasa.gov/apod/image/0608/hbm31_jcc_big.jpg"),
//                LocalDate.parse("2006-08-13", incomingDateFormat)
//            ),
//            Apod(
...
//                "Mohan",
//                URL("https://apod.nasa.gov/apod/image/1110/macs1206_hst_973.jpg"),
//                LocalDate.parse("2006-08-13", incomingDateFormat)
//            ),
//            Apod(
...
//                "MWV Observatory",
//                URL("https://apod.nasa.gov/apod/image/1305/ASE_McCarty3-3.jpg"),
//                LocalDate.parse("2006-08-13", incomingDateFormat)
//            ),
//            Apod(
...
//                "Brian Lula",
//                URL("https://apod.nasa.gov/apod/image/0710/vdB142_lula.jpg"),
//                LocalDate.parse("2006-08-13", incomingDateFormat)
//            ),
//            Apod(
...
//                "Jingyi Zhang",
//                URL("https://apod.nasa.gov/apod/image/1902/DragonAurora_Zhang_2241.jpg"),
//                LocalDate.parse("2006-08-13", incomingDateFormat)
//            ),
//            Apod(
...
//                "SSRO",
//                URL("https://apod.nasa.gov/apod/image/1301/NGC4945_Master23.jpg"),
//                LocalDate.parse("2006-08-13", incomingDateFormat)
//            ),
//        )
//    )
